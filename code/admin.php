...
class GDBTOAdmin {
	...
	public function admin_menu() {
		$this->page_ids[] = add_submenu_page( 'edit.php?post_type=forum', 'GD bbPress Tools', __( 'Tools', 'gd-bbpress-tools' ), GDBBPRESSTOOLS_CAP, 'gdbbpress_tools', array(
			$this,
			'menu_tools',
		) );
	...
	public function plugin_actions( $links, $file ) {
		if ( $file == 'gd-bbpress-tools/gd-bbpress-tools.php' ) {
			$settings_link = '<a href="edit.php?post_type=forum&page=gdbbpress_tools">' . esc_html__( 'Settings', 'gd-bbpress-tools' ) . '</a>';
	...
	public function plugin_links( $links, $file ) {
		if ( $file == 'gd-bbpress-tools/gd-bbpress-tools.php' ) {
			$links[] = '<a target="_blank" style="color: #cc0000; font-weight: bold;" href="https://www.dev4press.com/plugins/gd-bbpress-toolbox/">' . esc_html__( 'Upgrade to GD bbPress Toolbox Pro', 'gd-bbpress-tools' ) . '</a>';
		}
	...
	public function load_admin_page() {
		...
		$screen->set_help_sidebar( '
            ...
            <p><a target="_blank" href="https://www.dev4press.com/">' . esc_html__( 'Website', 'gd-bbpress-tools' ) . '</a></p>
            <p><a target="_blank" href="https://twitter.com/milangd">' . esc_html__( 'On Twitter', 'gd-bbpress-tools' ) . '</a></p>
            <p><a target="_blank" href="https://facebook.com/dev4press">' . esc_html__( 'On Facebook', 'gd-bbpress-tools' ) . '</a></p>' );

		$screen->add_help_tab( array(
			"id"      => "gdpt-screenhelp-help",
			"title"   => esc_html__( 'Get Help', 'gd-bbpress-tools' ),
			"content" => '<h2>' . esc_html__( 'General Plugin Information', 'gd-bbpress-tools' ) . '</h2>
                <p><a href="https://www.dev4press.com/plugins/gd-bbpress-tools/" target="_blank">' . esc_html__( 'Home Page on Dev4Press.com', 'gd-bbpress-tools' ) . '</a> | 
                <a href="https://wordpress.org/plugins/gd-bbpress-tools/" target="_blank">' . esc_html__( 'Home Page on WordPress.org', 'gd-bbpress-tools' ) . '</a></p> 
                <h2>' . esc_html__( 'Getting Plugin Support', 'gd-bbpress-tools' ) . '</h2>
                <p><a href="https://support.dev4press.com/forums/forum/plugins-free/gd-bbpress-tools/" target="_blank">' . esc_html__( 'Support Forum on Dev4Press.com', 'gd-bbpress-tools' ) . '</a> | 
                <a href="https://wordpress.org/support/plugin/gd-bbpress-tools" target="_blank">' . esc_html__( 'Support Forum on WordPress.org', 'gd-bbpress-tools' ) . '</a></p>',
		) );
		...
		$screen->add_help_tab( array(
			...
			"title"   => "Dev4Press",
			"sfc",
			"content" => '<p>' . esc_html__( 'On Dev4Press website you can find many useful plugins, themes and tutorials, all for WordPress. Please, take a few minutes to browse some of these resources, you might find some of them very useful.', 'gd-bbpress-tools' ) . '</p>
                <p><a href="https://www.dev4press.com/plugins/" target="_blank"><strong>' . esc_html__( 'Plugins', 'gd-bbpress-tools' ) . '</strong></a> - ' . esc_html__( 'We have more than 10 plugins available, some of them are commercial and some are available for free.', 'gd-bbpress-tools' ) . '</p>
                <p><a href="https://www.dev4press.com/kb/" target="_blank"><strong>' . esc_html__( 'Knowledge Base', 'gd-bbpress-tools' ) . '</strong></a> - ' . esc_html__( 'Premium and free tutorials for our plugins themes, and many general and practical WordPress tutorials.', 'gd-bbpress-tools' ) . '</p>
                <p><a href="https://support.dev4press.com/forums/" target="_blank"><strong>' . esc_html__( 'Support Forums', 'gd-bbpress-tools' ) . '</strong></a> - ' . esc_html__( 'Premium support forum for all with valid licenses to get help. Also, report bugs and leave suggestions.', 'gd-bbpress-tools' ) . '</p>',
		) );
	}
