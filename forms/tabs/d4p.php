...
<div class="d4p-information">
    <fieldset>
        <h3><?php esc_html_e( 'Premium Plugins for bbPress', 'gd-bbpress-tools' ); ?></h3>
    ...
    <fieldset>
        <h3><?php esc_html_e( 'Free and Lite Plugins for bbPress', 'gd-bbpress-tools' ); ?></h3>
    ...
    <fieldset>
        <h3><?php esc_html_e( 'Other Premium Plugins', 'gd-bbpress-tools' ); ?></h3>
        <a target="_blank" href="https://plugins.dev4press.com/coresecurity/">coreSecurity Pro</a><br/>
        <a target="_blank" href="https://sweep.press/">SweepPress Pro</a><br/>
        <a target="_blank" href="https://plugins.dev4press.com/breadcrumbspress/">BreadcrumbsPress Pro</a><br/>
        ...
        <a target="_blank" href="https://plugins.dev4press.com/gd-press-tools/">GD Press Tools Pro</a><br/>
        <a target="_blank" href="https://plugins.dev4press.com/gd-rating-system/">GD Rating System Pro</a>
    </fieldset>

    <fieldset>
        <h3><?php esc_html_e( 'More Free Plugins', 'gd-bbpress-tools' ); ?></h3>
